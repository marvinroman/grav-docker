...
### Versions
Docker Tag | Git Release | Grav Version | Nginx Version | PHP Version | Alpine Version | Status
-----|-------|-----|------|--------|-------- | -------
0.1 | Master Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Alpha
latest/0.1.1 | Master Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Alpha (includes hotfix to speed up startup)
skeleton-open-publishing-space-v1.5.5 | Master Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Alpha
skeleton-learn2-with-git-sync-v1.5.2 | Master Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Alpha
develop | Develop Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Development
feature-multisite | Multisite Branch | 1.6.10 | 1.16.0 | 7.3.6 | 3.9 | Experimental
